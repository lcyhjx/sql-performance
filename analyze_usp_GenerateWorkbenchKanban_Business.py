# -*- coding: utf-8 -*-
"""
存储过程性能分析脚本: usp_GenerateWorkbenchKanban_Business
连接数据库并获取存储过程定义和性能信息
"""
...
def main():
    """主函数"""
    sp_name = 'dbo.usp_GenerateWorkbenchKanban_Business'
    ...
    if sp_definition:
        ...
        # 保存到文件
        output_file = 'usp_GenerateWorkbenchKanban_Business_definition.sql'
